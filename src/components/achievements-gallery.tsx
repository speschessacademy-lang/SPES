...
export default function AchievementsGallery({ items }: { items: AchievementItem[] }) {
    ...
    <section id="achievements" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="text-[#6E5A8E] max-w-3xl mx-auto">
            Highlights from tournaments, training camps, and proud moments.
          </p>
        </div>
        ...
        {visibleItems.length > 0 ? (
          ...
          <div className="text-center text-[#6E5A8E]">
            Add images via the admin to populate this gallery.
          </div>
        )}
